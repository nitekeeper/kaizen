...
```
PYTHONPATH=. python3 scripts/project.py get-by-url <git-url>
```
...
3. Invoke the interactive register flow:
   ...
   ```
   PYTHONPATH=. python3 scripts/project.py register <git-url>
   ```
...
```
PYTHONPATH=. python3 scripts/project.py list
```
...
```
PYTHONPATH=. python3 scripts/project.py edit <id> --field=value [--field=value ...]
```
